<template>
  <div class="current-weather">
    <div class="container">
      ...
      <div class="high-low-temperature">
          <div class="high">
      ...
      </div><!-- high-low-temperature -->
      <span class="condition">{{this.currentWeather.weather[0].discription}}</span>
      <span class="feels-like">Fells like 
